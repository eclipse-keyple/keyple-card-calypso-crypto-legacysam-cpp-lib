 ...
 * @since 2.0.0
 */
class KEYPLECARDCALYPSOCRYPTOLEGACYSAM_API LegacySamConstants {
public:
    ...
    static const uint8_t AID_SIZE_MAX;
    ...
    static const uint8_t TARGET_IS_SYSTEM_KEY_FILE;
    static const uint8_t TARGET_IS_LOCK_FILE;
    static const uint8_t RECORD_CHOSEN_BY_THE_SAM;

    static const uint8_t FIRST_EVENT_CEILING_RECORD_REFERENCE;
    static const uint8_t SINGLE_CEILING_REFERENCE;

    static const uint8_t LOCK_KIF;

    static const uint8_t DYNAMIC_MODE_CIPHERING;
    static const uint8_t STATIC_MODE_CIPHERING;
