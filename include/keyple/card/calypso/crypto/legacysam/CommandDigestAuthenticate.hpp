 ...
 * @since 2.0.1
 */
class KEYPLECARDCALYPSOCRYPTOLEGACYSAM_API CommandDigestAuthenticate
...
public:
     ...
     * @throws IllegalArgumentException If the signature is null or has a wrong
     * length.
     * @since 2.0.1
     */
    CommandDigestAuthenticate(
